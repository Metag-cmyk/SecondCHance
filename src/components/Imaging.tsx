...
export default function Imaging() {
  return (
    <div className="space-y-6">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-slate-900">Imaging & Echo</h2>
        <p className="text-slate-500 mt-1">Echocardiography parameters, ECG criteria, and imaging modalities.</p>
      </div>
